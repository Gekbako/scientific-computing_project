...
The data collected from these two is saved in many different data files and then used in python files plots, such as visual_1.py etc. etc. These can be compiled, for example, in Visulal Studio Code,
where data is presented in the form of gras
